...
export interface ApiAnalyticAnalytic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    interactions: Schema.Attribute.Enumeration<
      ['saved', 'attended', 'searched']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    event_image: Schema.Attribute.Media<
      ...
      true
    >;
    is_live_stream: Schema.Attribute.Boolean;
    ...
    organiser_id: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHostHost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    permission: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLiveStreamLiveStream extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chat_enabled: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stream_url: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    membership_balance: Schema.Attribute.Decimal;
...
export interface ApiSubscriptionPlanSubscriptionPlan
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    plan_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    time_period_months: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    subscription_fee: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.String;
